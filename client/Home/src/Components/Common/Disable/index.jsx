        ...
        <div className="home-block">
          <div className="home-block-inner">
            ...
            <nav className="usefull-nav usefull-nav-pinned d-none d-xl-flex">
              <ul>
                <li><a href={options[0].facebook}><i className="ui-facebook" /></a></li>
                <li><a href={options[0].twitter}><i className="ui-twitter" /></a></li>
                <li><a href={options[0].instagram}><i className="ui-instagram" /></a></li>
              </ul>
            </nav>
            )}
